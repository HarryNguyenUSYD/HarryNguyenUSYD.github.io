...
Let's pay our attention to the `Program.cs` only for now. As mentioned earlier, this will be the entry point of your project. We can customize this
file to expand our project from the sample.

Since we are only starting to use .NET, let's make something simple: a greeting program. The program will ask you for your name and print out
a greeting for you.
...
And you're done! You have implemented a feature to your first .NET project. While your project is small for now, it will undoubtedly grow larger and
better as you learn.

# Conclusion

And that's all for today's episode. Next week we will take a look at the basic concepts of C#, and further expand upon your project.
