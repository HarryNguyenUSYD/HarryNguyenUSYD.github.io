...
<Table
    columns={["Function", "Use", "Example"]}
    content={[
        ["arr.Any()", "Checks if any element satisfies a condition", "arr.Any(x => x > 5)"],
        ["arr.All()", "Checks if all elements satisfy a condition", "arr.All(x => x > 0)"],
        ["arr.Where()", "Filters array based on condition", "arr.Where(x => x % 2 == 0).ToArray()"],
        ["arr.Select()", "Projects each element into a new form", "arr.Select(x => x * x).ToArray()"],
        ["arr.Sum()", "Adds all elements", "arr.Sum()"],
        ["arr.Max()", "Finds the maximum element", "arr.Max()"],
        ["arr.Min()", "Finds the minimum element", "arr.Min()"],
        ["arr.Average()", "Calculates the average", "arr.Average()"]
    ]}
/>
...
Lists in C# is a class that represents a linked list data structure. Linked list is similar to an array with flexible sizes. To use them, import the
namespace `System.Collections.Generic` at the top of your file. We will talk about imports in more details next week.

Linked list is a great data structure to store data of uncertain sizes or growing data (such as the information of users). However, they can be much slower
than arrays, especially as the size of the list grows larger. That said, this is still one of the most common data structures you will see in all sorts
of projects, including .NET ones. 
...
<Table
    columns={["Function", "Use", "Example"]}
    content={[
        ["numbers.Add(10)", "Adds an element", "numbers.Add(10);"],
        ["numbers.Remove(10)", "Removes the first occurrence of an item", "numbers.Remove(10);"],
        ["numbers.RemoveAt(0)", "Removes an element at a specific index", "numbers.RemoveAt(0);"],
        ["numbers.Insert(1, 20)", "Inserts item at a specific position", "numbers.Insert(1, 20);"],
        ["numbers.Contains(20)", "Checks if the item exists", "numbers.Contains(20);"],
        ["numbers.IndexOf(20)", "Gets the index of the item", "numbers.IndexOf(20);"],
        ["numbers.Clear()", "Removes all elements", "numbers.Clear();"],
        ["numbers.Count", "Returns the number of elements", "int total = numbers.Count;"],
        ["numbers.Sort()", "Sorts the list in ascending order", "numbers.Sort();"],
        ["numbers.Reverse()", "Reverses the list", "numbers.Reverse();"]
    ]}
/>
...
but come with large storage overhead.
...
<Table
    columns={["Function", "Use", "Example"]}
    content={[
        ["dict.Add(\"Tom\", 35)", "Adds a new key-value pair", "dict.Add(\"Tom\", 35);"],
        ["dict.Remove(\"Tom\")", "Removes a key-value pair", "dict.Remove(\"Tom\");"],
        ["dict.ContainsKey(\"Alice\")", "Checks if a key exists", "dict.ContainsKey(\"Alice\");"],
        ["dict.ContainsValue(30)", "Checks if a value exists", "dict.ContainsValue(30);"],
        ["dict.TryGetValue(\"Alice\", out age)", "Gets a value safely without throwing", "dict.TryGetValue(\"Alice\", out age);"],
        ["dict.Count", "Number of items in the dictionary", "int total = dict.Count;"],
        ["dict.Keys", "Returns all keys", "foreach (var key in dict.Keys)"],
        ["dict.Values", "Returns all values", "foreach (var value in dict.Values)"],
        ["dict.Clear()", "Removes all entries", "dict.Clear();"]
    ]}
/>
