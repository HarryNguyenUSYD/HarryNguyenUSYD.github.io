...
If you want to learn about the history of programming and types of programming languages, check out the previous episode
<Redirect name="here" url="/blogs/programming-1" />.
